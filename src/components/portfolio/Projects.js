export const Projects = [
  {
    ...
    title: "Share Shed",
    tech: "Node, MySQL",
    description: "Enables users to earn a rental income from tools they own but only use occasionally.",
  ...
  },
  {
    ...
    description: "A 5 day weather forecast dashboard application using the third-party API Openweathermap.",
  ...
  },
  {
    ...
    title: "Plate Pals",
    tech: "Node, MySQL",
    description: "Simple food and cocktail recipes from around the world to try out with your friends.",
    deployedLink: "https://obscure-woodland-19082.herokuapp.com/",
    github: "https://github.com/wolldog/share-shed",
    image: "plate-pals",
  ...
  },
  {
    ...
    title: "BlogIT",
    tech: "Node, MySQL",
    description: "A CMS-style blog site where developers can publish their thoughts and ideas.",
